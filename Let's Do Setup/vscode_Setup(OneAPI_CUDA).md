...
![image](../Markdown%20Image/vs_oneAPI_tools.png)


以下是成功安裝Intel Visual Fortran以及Intel DPCPP/CPP後，在Visual Studio中看起來的樣子:
![image](../Markdown%20Image/vs_oneAPI_ifort.png)
![image](../Markdown%20Image/vs_oneAPI_dpcpp.png)
...
安裝第一步，需要同意軟體授權協議同意書:
   ...
   ![image](../Markdown%20Image/vs_cuda_1.png)

再來可以選擇預設或自訂選擇元件安裝:

   ![image](../Markdown%20Image/vs_cuda_2.png)

我們選擇CUDA套件:

   ![image](../Markdown%20Image/vs_cuda_3.png)

安裝的Nsight會自動偵測並整合至Visual Studio。

   ![image](../Markdown%20Image/vs_cuda_4.png)

這是可以建立NVIDIA CUDA Runtime看起來的樣子:
   ![image](../Markdown%20Image/vs_cuda_VS2022.png)
